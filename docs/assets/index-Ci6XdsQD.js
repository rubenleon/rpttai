import{t as e}from"./githubStart-B6S0mawn.js";/* empty css             */e();var t={A1:974,A2:1737,B:5,C1:5642,C2:64},n=document.getElementById(`cuerposRanking`);if(n){let e=Object.values(t).reduce((e,t)=>e+t,0),r=new Intl.NumberFormat(`es-ES`);n.innerHTML=Object.entries(t).sort(([,e],[,t])=>t-e).map(([t,n],i)=>{let a=n/e*100,o=a.toLocaleString(`es-ES`,{minimumFractionDigits:1,maximumFractionDigits:1});return`
