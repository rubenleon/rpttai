import{t as e}from"./githubStart-u1emfE8W.js";/* empty css             */import{t}from"./table-sort-eicihVap.js";/* empty css                 */import{t as n}from"./preload-helper-Czpn1I53.js";e();var r=e=>{let t=String(e??``).trim();return t===`V`?`Vacante`:t===`NV`?`No vacante`:t};t(),(async()=>{let e=document.getElementById(`datosTabla`);if(e.innerHTML.trim())return;e.innerHTML=`<tr><td colspan="12">Cargando nuevas plazas...</td></tr>`;let{puestos:t}=await n(async()=>{let{puestos:e}=await import(`./rpt-D4SbeSDs.js`);return{puestos:e}},[]),i=``,a=1;t.forEach(e=>{e[31].split(`:`)[0]==`NEW`&&(i+=`
          <tr>
