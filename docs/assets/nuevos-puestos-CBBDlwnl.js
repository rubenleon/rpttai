import{s as l}from"./githubStart-BWgQO704.js";/* empty css             */import{p as a}from"./buscador-BPsYvb9x.js";l();let d="",s=1;a.forEach(t=>{t[31].split(":")[0]=="NEW"&&(console.log({item:t}),d+=`
        <tr>
