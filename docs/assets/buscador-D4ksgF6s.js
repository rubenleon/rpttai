import{s as B}from"./githubStart-BWgQO704.js";import{p as M}from"./buscador-HNizyDuB.js";const S={"02":"Albacete","03":"Alicante","04":"Almería","01":"Álava",33:"Asturias","05":"Ávila","06":"Badajoz","07":"Illes Balears","08":"Barcelona",48:"Bizkaia","09":"Burgos",10:"Cáceres",11:"Cádiz",39:"Cantabria",12:"Castellón",13:"Ciudad Real",14:"Córdoba",15:"A Coruña",16:"Cuenca",20:"Gipuzkoa",17:"Girona",18:"Granada",19:"Guadalajara",21:"Huelva",22:"Huesca",23:"Jaén",24:"León",25:"Lleida",27:"Lugo",28:"Madrid",29:"Málaga",30:"Murcia",31:"Navarra",32:"Ourense",34:"Palencia",35:"Las Palmas",36:"Pontevedra",26:"La Rioja",37:"Salamanca",38:"Santa Cruz de Tenerife",40:"Segovia",41:"Sevilla",42:"Soria",43:"Tarragona",44:"Teruel",45:"Toledo",46:"Valencia",47:"Valladolid",49:"Zamora",50:"Zaragoza",51:"Ceuta",52:"Melilla",todas:"Puestos de trabajo en todas las provincias"};function x(o,l){let s=o[31];console.log("rpttexto_cambios: ",s);const a=s.split(":");let e="";if(a[0]=="S"){let n=a[1].split("|");console.log("PartesRPT: ",{partesRPT:n}),e="Si, ";let d=n[0],i=n[1],t=n[2];d!="="&&d!=null&&(e+=`<strong>Nivel:</strong> En la rpt <q><i>${l}</i></q> era: <mark>${d}</mark>`),i!="="&&i!=null&&(e+=`<strong>Complemento:</strong> En la rpt <q><i>${l}</i></q> era: <mark>${i}</mark>`),t!="="&&t!=null&&(e+=`<strong>Estado:</strong> En la rpt <q><i>${l}</i></q> era: <mark>${t}</mark>`),e+=""}else a[0]=="NEW"?e+='<img width="40" height="40" src="https://img.icons8.com/ultraviolet/40/new.png" alt="new"/> Nuevo puesto':e="No";return e}const P=()=>{const o=document.getElementById("cookie-banner"),l=document.getElementById("accept-cookies");localStorage.getItem("cookiesAccepted")||(o.style.display="block"),l.addEventListener("click",function(){localStorage.setItem("cookiesAccepted","true"),o.style.display="none",s()}),localStorage.getItem("cookiesAccepted")&&s();function s(){console.log("Cargando Google AdSense...");const a=document.createElement("script");a.src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-7327811292507079",a.async=!0,a.setAttribute("crossorigin","anonymous"),document.head.appendChild(a)}};let T="1 de Septiembre del 2025";B();let h=0,w=1,D=3,I=5,_=8,A=10,O=11,j=13,f=14,q=15,b=19,z=25,G=27,N=28,H=29,r=30,c=new Map,v=0,p=0,E="",C=document.getElementById("contenedor-puestos"),y=document.getElementById("search"),g=document.getElementById("btn_enviar");document.getElementById("btn_info");document.getElementById("select_html");let $=document.getElementById("cuerpo"),k=document.getElementById("sVacantes"),m="";g.addEventListener("click",o=>{o.preventDefault(),E=y.value.toLowerCase(),g.innerHTML='<span aria-busy="true">Buscando...</span>',new Promise((s,a)=>{setTimeout(()=>{v=0,p=0,C.innerHTML="",c=new Map;let e=y.value;R(e),s("ok")},2e3)}).then(s=>{g.innerHTML=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" width="24" height="24" stroke-width="2">
        ...
        <h1> <img width="48" height="48" src="https://img.icons8.com/pulsar-gradient/48/city.png" alt="city"/> ${S[o]}: </h1>
        <p><mark class="mark-cont">${v}</mark> plazas vacantes de <strong>${p}</strong> puestos</p>`;for(let n of c.keys()){let d=0,i=`
            ...
            <table class="tablaMinisterios">
              <thead>
                ...
                <tbody>
            `;a=0,c.get(n).forEach(t=>{a++;let L=x(t,T),u="";t[r]=="V"?(u="span-vacante",d++):u="",m=t[H],m=="OEP"&&(m="OEP"),i+=`
                <tr>
            ...
            `,e++}}a>0&&(C.innerHTML=s),l==!1&&(document.querySelector("#form-contenedor").classList="ocultar",document.getElementById("filtro").innerHTML='<button class="secondary">🎯 Mostrar formulario</button>',document.getElementById("filtro").style.padding="5px")};let V=document.getElementById("filtro");V.addEventListener("click",()=>{document.querySelector("#form-contenedor").classList=""});document.addEventListener("DOMContentLoaded",o=>{P()});
